...
<b><label for="domain">Domain Name:</label></b> <input type="text" name="domain" id="domain" value="<?php echo isset($_GET['domain']) ? $_GET['domain'] : '' ?>"> <input type="submit" value="Lookup">
</form>
<?php
echo $domainname;
/////////////////////////////////////////////////////////////////////
